...
task_data_t control_task_data = {0};
...
void init()
{
    ...
    control_task_data.task_func = control_task;
    control_task_data.task_name = "control_task";
    control_task_data.config.core = 0;
    control_task_data.config.priority = 10;
    control_task_data.config.stack_size = 8000;
    create_task(control_task_data);
...
void get_mac(uint8_t mac[6])
{
    ...
    // esp_err_t err = esp_read_mac(mac, ESP_MAC_BT);        // bluetooth
}